...
- [x] **Pressing Escape on the first checkbox item converts all remaining items to a plain list** Expected: only the first item is demoted to a paragraph, rest remain as checkboxes.
...
- [x] **Text promoted from a heading retains heading styling** When text is moved out of a heading block into body content, it keeps the heading's visual style. Expected: it becomes a plain paragraph.
